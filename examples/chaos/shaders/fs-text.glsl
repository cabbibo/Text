...
void main(){
  ...
  float distance1 = texture2D(t_text , sCoord + vec2( 0. , speed/1.)  ).a;
  float distance2 = texture2D(t_text , sCoord + vec2( 0. , speed/1.) ).a;

  distance = (distance + distance1 + distance2 ) / 3.;
